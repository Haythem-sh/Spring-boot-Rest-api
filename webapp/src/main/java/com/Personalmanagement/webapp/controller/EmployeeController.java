package com.Personalmanagement.webapp.controller;
...
import com.Personalmanagement.webapp.model.Admin;
import com.Personalmanagement.webapp.model.Employee;
import com.Personalmanagement.webapp.service.EmployeeService;
...
public class EmployeeController {
	...
	@PostMapping("/")
	public ModelAndView log_validation(@ModelAttribute Admin admin) {
        if((admin.getUserName()).equals("admin") && (admin.getAdminPassword()).equals("admin") ) {
